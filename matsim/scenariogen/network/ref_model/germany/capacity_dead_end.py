# -*- coding: utf-8 -*-
"""XGBRegressor(alpha=0.07346195485353985, base_score=0.5, booster='gbtree',
             callbacks=None, colsample_bylevel=1, colsample_bynode=0.9,
             colsample_bytree=0.9, early_stopping_rounds=None,
             enable_categorical=False, eta=0.9005496527242473,
             eval_metric='mae', feature_types=None, gamma=0.3913205082310667,
             gpu_id=-1, grow_policy='depthwise', importance_type=None,
             interaction_constraints='', lambda=0.03399177215713073,
             learning_rate=0.90054965, max_bin=256, max_cat_threshold=64,
             max_cat_to_onehot=4, max_delta_step=0, max_depth=4, max_leaves=0,
             min_child_weight=1, missing=nan, monotone_constraints='()',
             n_estimators=20, n_jobs=0, ...)
Error: 17.650743"""
def features(ft, data):
		data[0] = (ft.get("length") - 121.64943999999997) / 102.75395159548076
		data[1] = (ft.get("speed") - 15.9616) / 4.368329731144388
		data[2] = (ft.get("num_lanes") - 1.856) / 0.8551397546600205
...
def score(params, inputs):
    if inputs[0] >= -0.8462881:
        ...
        if inputs[0] >= -1.0267677:
            if inputs[0] >= -1.002243:
                if inputs[0] >= -0.96248794:
                    var0 = params[7]
                else:
                    var0 = params[8]
            else:
            ...
            var0 = params[10]
    if inputs[0] >= 0.46680015:
        if inputs[0] >= 1.0344182:
            if inputs[1] >= 0.47922206:
                if inputs[2] >= -0.41630626:
                    var1 = params[11]
                else:
                    var1 = params[12]
            else:
                if inputs[0] >= 1.3222904:
                    var1 = params[13]
                else:
                    var1 = params[14]
        else:
        ...
        if inputs[0] >= -0.69982165:
            if inputs[1] >= -0.792431:
                if inputs[2] >= 0.75309324:
                    var1 = params[17]
                else:
                    var1 = params[18]
            else:
            ...
            if inputs[2] >= 1.9224927:
                if inputs[0] >= -0.76804286:
                    var1 = params[20]
                else:
                    var1 = params[21]
            else:
                if inputs[0] >= -0.82147145:
                    ...
                    var1 = params[23]
    if inputs[0] >= 1.4293422:
        if inputs[1] >= -0.15603217:
            if inputs[0] >= 1.4803379:
                if inputs[2] >= 0.1683935:
                    var2 = params[24]
                else:
                    var2 = params[25]
            else:
        ...
        if inputs[0] >= 1.3335794:
            var2 = params[28]
        else:
            if inputs[11] >= 0.5:
                if inputs[0] >= 0.04920064:
                    var2 = params[29]
                else:
                    var2 = params[30]
            else:
                if inputs[0] >= -0.45715457:
                    var2 = params[31]
                else:
                    var2 = params[32]
    if inputs[0] >= 1.3335794:
        if inputs[0] >= 2.015451:
            if inputs[0] >= 2.0768113:
                if inputs[2] >= -0.41630626:
                    var3 = params[33]
                else:
                    var3 = params[34]
            ...
            if inputs[0] >= 1.6961446:
                var3 = params[36]
            else:
                var3 = params[37]
    else:
        if inputs[0] >= -0.87937677:
            if inputs[0] >= -0.86414623:
                if inputs[0] >= -0.28796402:
                    var3 = params[38]
                else:
                    var3 = params[39]
            else:
            ...
            if inputs[0] >= -0.90594506:
                if inputs[0] >= -0.8935368:
                    var3 = params[41]
                else:
                    var3 = params[42]
            else:
    ...
    if inputs[1] >= -0.15603217:
        if inputs[2] >= 0.75309324:
            if inputs[0] >= -0.4062563:
                if inputs[0] >= 1.246089:
                    var4 = params[45]
                else:
                    var4 = params[46]
            else:
                if inputs[0] >= -0.5137947:
                    var4 = params[47]
                else:
                    var4 = params[48]
        else:
            if inputs[4] >= -0.5:
                if inputs[1] >= 1.7508751:
                    var4 = params[49]
                else:
                    var4 = params[50]
            else:
                if inputs[0] >= 1.2568915:
                    var4 = params[51]
                else:
                    var4 = params[52]
    else:
        if inputs[2] >= 0.75309324:
            if inputs[0] >= -0.040090334:
                if inputs[0] >= 0.20423117:
                    var4 = params[53]
                else:
                    var4 = params[54]
            else:
            ...
            if inputs[0] >= -0.45715457:
                if inputs[0] >= 0.47254202:
                    var4 = params[57]
                else:
                    var4 = params[58]
            else:
                if inputs[0] >= -0.74955213:
                    var4 = params[59]
                else:
                    var4 = params[60]
    if inputs[0] >= -0.82750535:
        if inputs[0] >= -0.680601:
            if inputs[0] >= -0.41589096:
                if inputs[0] >= -0.28796402:
                    var5 = params[61]
                else:
                    var5 = params[62]
            else:
                if inputs[0] >= -0.44343248:
                    var5 = params[63]
                else:
                    var5 = params[64]
        else:
            if inputs[0] >= -0.68989503:
                var5 = params[65]
            else:
                if inputs[0] >= -0.69982165:
                    var5 = params[66]
        ...
        if inputs[0] >= -0.87937677:
            ...
            if inputs[0] >= -0.96248794:
                ...
                if inputs[0] >= -1.0267677:
                    ...
                    var5 = params[73]
    if inputs[0] >= -0.7369492:
        if inputs[0] >= -0.70867777:
            if inputs[10] >= 0.5:
                if inputs[0] >= -0.10972269:
                    var6 = params[74]
                else:
                    var6 = params[75]
            else:
                if inputs[0] >= -0.5848869:
                    var6 = params[76]
                else:
                    var6 = params[77]
        else:
            if inputs[0] >= -0.7131058:
                var6 = params[78]
            else:
                if inputs[0] >= -0.7254168:
                    var6 = params[79]
                else:
                    var6 = params[80]
    else:
        if inputs[0] >= -0.74955213:
            ...
            if inputs[0] >= -0.77728826:
                ...
                if inputs[2] >= 0.1683935:
                    ...
                    var6 = params[84]
    if inputs[1] >= -0.15603217:
        if inputs[0] >= -0.3979841:
            if inputs[0] >= -0.16801728:
                if inputs[0] >= 0.1484669:
                    var7 = params[85]
                else:
                    var7 = params[86]
            else:
        ...
        if inputs[0] >= -0.22996137:
            if inputs[0] >= 0.04920064:
                if inputs[0] >= 0.14014605:
                    var7 = params[91]
                else:
                    var7 = params[92]
            else:
            ...
            if inputs[0] >= -0.2746312:
                var7 = params[95]
            else:
                if inputs[0] >= -0.34275508:
                    var7 = params[96]
                else:
                    var7 = params[97]
    if inputs[0] >= -0.4512667:
        if inputs[2] >= -0.41630626:
            if inputs[0] >= -0.43516028:
                if inputs[0] >= 1.7182848:
                    var8 = params[98]
                else:
                    var8 = params[99]
            else:
        ...
        if inputs[2] >= -0.41630626:
            if inputs[0] >= -0.48907548:
                if inputs[0] >= -0.4726284:
                    var8 = params[105]
                else:
                    var8 = params[106]
            else:
                if inputs[0] >= -0.52839273:
                    var8 = params[107]
                else:
                    var8 = params[108]
        else:
            if inputs[0] >= -0.5803615:
                var8 = params[109]
            else:
                if inputs[0] >= -0.82147145:
                    var8 = params[110]
                    ...
                    var8 = params[111]
    if inputs[2] >= 0.75309324:
        if inputs[0] >= 0.29619843:
            if inputs[0] >= 1.3367424:
                var9 = params[112]
            else:
                if inputs[0] >= 0.46680015:
                    var9 = params[113]
        ...
        if inputs[0] >= 1.3335794:
            ...
            if inputs[0] >= 1.1876483:
                if inputs[0] >= 1.221759:
                    var9 = params[122]
                else:
                    var9 = params[123]
            else:
                if inputs[0] >= 1.1512506:
                    var9 = params[124]
                else:
                    var9 = params[125]
    if inputs[1] >= -0.15603217:
        ...
        if inputs[0] >= -0.45715457:
            if inputs[1] >= -1.4288299:
                if inputs[0] >= -0.42426047:
                    var10 = params[133]
                else:
                    var10 = params[134]
            else:
                if inputs[0] >= 1.8040724:
                    var10 = params[135]
                else:
                    var10 = params[136]
        else:
            if inputs[2] >= -0.41630626:
                if inputs[0] >= -0.6213819:
                    var10 = params[137]
                else:
                    var10 = params[138]
            else:
                if inputs[0] >= -0.92930186:
                    var10 = params[139]
                else:
                    var10 = params[140]
    if inputs[1] >= 3.3407278:
        var11 = params[141]
    else:
        if inputs[0] >= 0.85053235:
            if inputs[0] >= 1.1512506:
                if inputs[0] >= 1.1876483:
                    var11 = params[142]
                else:
    ...
    if inputs[0] >= -0.28796402:
        if inputs[0] >= -0.22996137:
            if inputs[0] >= 0.3694316:
                if inputs[0] >= 0.64917755:
                    var14 = params[169]
                else:
                    var14 = params[170]
            else:
                if inputs[0] >= 0.3540551:
                    var14 = params[171]
                else:
                    var14 = params[172]
        else:
            if inputs[0] >= -0.27424192:
                var14 = params[173]
            else:
                var14 = params[174]
    else:
        if inputs[0] >= -0.32484823:
            var14 = params[175]
        else:
            if inputs[0] >= -0.41589096:
                var14 = params[176]
