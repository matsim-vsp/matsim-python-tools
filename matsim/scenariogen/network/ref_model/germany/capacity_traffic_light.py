# -*- coding: utf-8 -*-
"""XGBRegressor(alpha=0.08611386023702905, base_score=0.5, booster='gbtree',
             callbacks=None, colsample_bylevel=1, colsample_bynode=0.9,
             colsample_bytree=0.9, early_stopping_rounds=None,
             enable_categorical=False, eta=0.5221569428936291,
             eval_metric='mae', feature_types=None, gamma=0.04039757753888484,
             gpu_id=-1, grow_policy='depthwise', importance_type=None,
             interaction_constraints='', lambda=0.10033750030576022,
             learning_rate=0.522156954, max_bin=256, max_cat_threshold=64,
             max_cat_to_onehot=4, max_delta_step=0, max_depth=4, max_leaves=0,
             min_child_weight=7, missing=nan, monotone_constraints='()',
             n_estimators=30, n_jobs=0, ...)
Error: 173.054843"""
def features(ft, data):
		data[0] = (ft.get("length") - 107.8300974851653) / 88.3127424806261
		data[1] = (ft.get("speed") - 14.238025572195534) / 3.7074142979554225
		data[2] = (ft.get("num_lanes") - 1.8936140152585477) / 0.8774023537080416
...
def score(params, inputs):
    if inputs[0] >= 0.09302058:
        if inputs[6] >= 5.5:
            if inputs[0] >= 0.70052063:
                if inputs[1] >= -1.218646:
                    var0 = params[0]
                else:
                    var0 = params[1]
            else:
        ...
        if inputs[6] >= 4.5:
            if inputs[5] >= 2.5:
                ...
                if inputs[1] >= 0.28105152:
                    var0 = params[10]
                else:
                    var0 = params[11]
        else:
            if inputs[0] >= -0.68410397:
                if inputs[6] >= 3.5:
                    var0 = params[12]
                else:
                    var0 = params[13]
            else:
                if inputs[0] >= -0.88130087:
                    var0 = params[14]
                else:
                    var0 = params[15]
    if inputs[2] >= -0.44861287:
        if inputs[5] >= 2.5:
            if inputs[1] >= 1.0295516:
                if inputs[3] >= -10.0:
                    var1 = params[16]
                else:
                    var1 = params[17]
    ...
    if inputs[4] >= -0.5:
        ...
        if inputs[2] >= 0.6911151:
            ...
            if inputs[1] >= 1.0295516:
                if inputs[1] >= 2.9028249:
                    var3 = params[60]
                else:
                    var3 = params[61]
            else:
                if inputs[0] >= 0.099814616:
                    var3 = params[62]
                else:
                    var3 = params[63]
    if inputs[4] >= -0.5:
        if inputs[2] >= -0.44861287:
            if inputs[0] >= -0.590233:
                if inputs[5] >= 2.5:
                    var4 = params[64]
                else:
                    var4 = params[65]
        ...
        if inputs[2] >= 0.6911151:
            ...
            if inputs[0] >= -0.88452804:
                if inputs[0] >= -0.81109583:
                    var4 = params[76]
                else:
                    var4 = params[77]
            else:
                if inputs[1] >= 0.28105152:
                    ...
                    var4 = params[79]
    if inputs[0] >= -0.6641182:
        if inputs[0] >= 0.15620512:
            if inputs[5] >= 2.5:
                if inputs[6] >= 4.5:
                    var5 = params[80]
                else:
    ...
    if inputs[3] >= 4.165:
        if inputs[3] >= 5.5550003:
            if inputs[4] >= 0.5:
                if inputs[0] >= -0.9836644:
                    var6 = params[96]
                else:
                    var6 = params[97]
            else:
                if inputs[0] >= -0.68772745:
                    var6 = params[98]
                else:
                    var6 = params[99]
        else:
            if inputs[4] >= -0.5:
                ...
                if inputs[0] >= -0.8086613:
                    var6 = params[102]
                else:
                    var6 = params[103]
    else:
        if inputs[4] >= -0.5:
            if inputs[2] >= 1.830843:
                if inputs[8] >= 0.5:
                    var6 = params[104]
                else:
                    var6 = params[105]
            ...
            if inputs[2] >= 1.830843:
                ...
                if inputs[4] >= -1.5:
                    ...
                    var6 = params[111]
    if inputs[0] >= -0.456617:
        if inputs[5] >= 1.5:
            if inputs[0] >= 0.9316878:
                if inputs[5] >= 3.5:
                    var7 = params[112]
                else:
                    var7 = params[113]
            ...
            if inputs[4] >= -0.5:
                ...
                if inputs[0] >= -0.026384613:
                    var7 = params[118]
                else:
                    var7 = params[119]
    else:
        if inputs[0] >= -0.8788663:
            if inputs[1] >= 1.0295516:
                if inputs[11] >= 0.5:
                    var7 = params[120]
                else:
                ...
                if inputs[0] >= -0.78997767:
                    var7 = params[122]
                else:
                    var7 = params[123]
        else:
            if inputs[1] >= 2.5279005:
                if inputs[0] >= -0.9264246:
                    var7 = params[124]
                else:
                    var7 = params[125]
            else:
    ...
    if inputs[10] >= 0.5:
        ...
        if inputs[2] >= -0.44861287:
            if inputs[4] >= -0.5:
                if inputs[0] >= 0.11057184:
                    var8 = params[136]
                else:
                    var8 = params[137]
            else:
                if inputs[0] >= -0.6677983:
                    var8 = params[138]
                else:
                    var8 = params[139]
        else:
            if inputs[0] >= -0.9973091:
                if inputs[0] >= -0.95756394:
                    var8 = params[140]
                else:
                    var8 = params[141]
            else:
    ...
    if inputs[3] >= -5.5550003:
        if inputs[3] >= 1.385:
            if inputs[6] >= 4.5:
                ...
                if inputs[0] >= -0.9889864:
                    var9 = params[146]
                else:
                    var9 = params[147]
        else:
            if inputs[0] >= -1.1094673:
                if inputs[0] >= -1.0898212:
                    var9 = params[148]
                else:
                    var9 = params[149]
            else:
        ...
        if inputs[2] >= 0.6911151:
            ...
            if inputs[4] >= -0.5:
                ...
                if inputs[5] >= 1.5:
                    ...
                    var12 = params[204]
    if inputs[3] >= -5.5550003:
        if inputs[0] >= 4.074496:
            if inputs[5] >= 1.5:
                if inputs[0] >= 4.3374815:
                    var13 = params[205]
                else:
                    var13 = params[206]
            else:
            ...
            if inputs[0] >= -1.033091:
                if inputs[0] >= -0.92800987:
                    var13 = params[208]
                else:
                    var13 = params[209]
            else:
                if inputs[0] >= -1.0600407:
                    var13 = params[210]
                else:
                    var13 = params[211]
    else:
        if inputs[5] >= 1.5:
            ...
            if inputs[0] >= -0.9573375:
                if inputs[0] >= -0.8931339:
                    var13 = params[216]
                else:
                    var13 = params[217]
            else:
                var13 = params[218]
    if inputs[0] >= 0.8187369:
        if inputs[0] >= 1.7982671:
            if inputs[0] >= 2.2454846:
                if inputs[9] >= 0.5:
                    var14 = params[219]
                else:
                    var14 = params[220]
        ...
        if inputs[0] >= -0.38686487:
            if inputs[1] >= -1.218646:
                if inputs[0] >= 0.10847701:
                    var14 = params[227]
                else:
                    var14 = params[228]
            else:
            ...
            if inputs[1] >= -1.218646:
                ...
                if inputs[3] >= 5.5550003:
                    ...
                    var14 = params[234]
    if inputs[4] >= 1.5:
        if inputs[0] >= -0.92030996:
            if inputs[0] >= -0.8825464:
                if inputs[0] >= -0.84784025:
                    var15 = params[235]
                else:
                    var15 = params[236]
            else:
        ...
        if inputs[0] >= -1.0984836:
            if inputs[0] >= -1.0955961:
                if inputs[0] >= 4.2805815:
                    var15 = params[241]
                else:
                    var15 = params[242]
            else:
            ...
            if inputs[6] >= 5.5:
                ...
                if inputs[4] >= -0.5:
                    ...
                    var15 = params[247]
    if inputs[0] >= 4.316533:
        var16 = params[248]
    else:
        if inputs[0] >= 4.282507:
            var16 = params[249]
        else:
            if inputs[2] >= 1.830843:
                if inputs[6] >= 9.5:
                ...
                if inputs[4] >= -1.5:
                    ...
                    var16 = params[253]
    if inputs[0] >= 1.0731735:
        if inputs[0] >= 1.4191599:
            if inputs[0] >= 1.4496765:
                if inputs[0] >= 1.5391879:
                    var17 = params[254]
                else:
                    var17 = params[255]
            else:
                if inputs[0] >= 1.4420332:
                    var17 = params[256]
                else:
                    var17 = params[257]
        else:
            if inputs[13] >= 0.5:
                if inputs[0] >= 1.2611985:
                    var17 = params[258]
                else:
                    var17 = params[259]
            else:
                if inputs[0] >= 1.248573:
                    var17 = params[260]
                else:
                    var17 = params[261]
    else:
        if inputs[0] >= 1.0697765:
            var17 = params[262]
        else:
            if inputs[3] >= -12.775:
                if inputs[3] >= -8.335:
    ...
    if inputs[6] >= 5.5:
        if inputs[8] >= 0.5:
            ...
            if inputs[0] >= -1.0908968:
                if inputs[0] >= -0.9190078:
                    var18 = params[271]
                else:
                    var18 = params[272]
            else:
        ...
        if inputs[0] >= -0.69622004:
            if inputs[0] >= -0.6800841:
                if inputs[7] >= 0.5:
                    var18 = params[274]
                else:
                    var18 = params[275]
            ...
            if inputs[0] >= -0.7900909:
                if inputs[7] >= 0.5:
                    var18 = params[278]
                else:
                    var18 = params[279]
            else:
                if inputs[0] >= -0.83668673:
                    var18 = params[280]
                else:
                    var18 = params[281]
    if inputs[3] >= 5.5550003:
    ...
    if inputs[6] >= 9.5:
        if inputs[5] >= 2.5:
            if inputs[6] >= 11.5:
                ...
                if inputs[0] >= -0.655569:
                    var21 = params[310]
                else:
                    var21 = params[311]
        else:
            if inputs[4] >= -0.5:
                if inputs[0] >= 0.16022491:
                    var21 = params[312]
                else:
                    var21 = params[313]
            else:
                if inputs[0] >= -0.35748065:
                    var21 = params[314]
                else:
                    var21 = params[315]
    else:
        if inputs[5] >= 3.5:
            if inputs[2] >= -0.44861287:
                ...
                if inputs[0] >= 0.22833514:
                    var21 = params[318]
                else:
                    var21 = params[319]
        else:
            if inputs[2] >= 0.6911151:
                if inputs[0] >= 1.5724787:
                    var21 = params[320]
                else:
                    var21 = params[321]
            else:
                if inputs[0] >= -0.7248682:
                    var21 = params[322]
                else:
                    var21 = params[323]
    if inputs[0] >= -0.9995737:
        if inputs[0] >= -0.99679947:
            if inputs[4] >= -1.5:
                if inputs[0] >= -0.70408976:
                    var22 = params[324]
                else:
                    var22 = params[325]
            else:
                if inputs[0] >= -0.4400282:
                    var22 = params[326]
                else:
                    var22 = params[327]
        else:
        ...
        if inputs[6] >= 2.5:
            if inputs[0] >= -1.0424328:
                if inputs[0] >= -1.0356953:
                    var22 = params[331]
                else:
                    var22 = params[332]
            else:
            ...
            var22 = params[335]
    if inputs[0] >= 3.4627495:
        if inputs[0] >= 3.604858:
            if inputs[6] >= 3.5:
                if inputs[0] >= 4.105069:
                    var23 = params[336]
                else:
                    var23 = params[337]
            else:
                if inputs[0] >= 3.9084382:
                    var23 = params[338]
                else:
                    var23 = params[339]
        else:
            if inputs[8] >= 0.5:
                ...
                if inputs[0] >= 3.5178943:
                    var23 = params[341]
                else:
                    var23 = params[342]
    else:
        if inputs[0] >= 3.2692895:
            if inputs[0] >= 3.395262:
                var23 = params[343]
            else:
                if inputs[0] >= 3.3073926:
                    var23 = params[344]
                else:
                    var23 = params[345]
        else:
            if inputs[0] >= 3.182835:
                var23 = params[346]
            else:
                if inputs[0] >= -0.70969486:
                    var23 = params[347]
                else:
                    var23 = params[348]
    if inputs[4] >= 0.5:
        if inputs[0] >= -0.8515203:
            if inputs[3] >= -1.39:
                if inputs[0] >= -0.80883116:
                    var24 = params[349]
                else:
                    var24 = params[350]
            else:
            ...
            if inputs[1] >= 0.28105152:
                ...
                if inputs[0] >= -0.97336006:
                    var24 = params[355]
                else:
                    var24 = params[356]
    else:
        if inputs[0] >= 3.9279711:
            if inputs[9] >= 0.5:
                if inputs[0] >= 4.2983027:
                    var24 = params[357]
                else:
                    var24 = params[358]
            else:
            ...
            if inputs[5] >= 1.5:
                ...
                if inputs[6] >= 4.5:
                    ...
                    var24 = params[364]
    if inputs[0] >= -0.96871746:
        if inputs[0] >= -0.95756394:
            if inputs[0] >= -0.9499773:
                if inputs[0] >= -0.9480523:
                    var25 = params[365]
                else:
                    var25 = params[366]
            else:
            ...
            if inputs[13] >= 0.5:
                ...
                if inputs[0] >= -0.9611874:
                    var25 = params[371]
                else:
                    var25 = params[372]
    else:
        if inputs[0] >= -0.97296375:
            if inputs[2] >= -0.44861287:
                if inputs[0] >= -0.97086895:
                    var25 = params[373]
                else:
                    var25 = params[374]
            else:
    ...
    if inputs[0] >= 0.10360795:
        ...
        if inputs[6] >= 4.5:
            if inputs[6] >= 5.5:
                if inputs[0] >= -0.7606501:
                    var26 = params[387]
                else:
                    var26 = params[388]
            else:
                if inputs[0] >= -0.6874443:
                    var26 = params[389]
                else:
                    var26 = params[390]
        else:
            if inputs[0] >= -0.22697854:
                if inputs[0] >= -0.2162213:
                    var26 = params[391]
                else:
                    var26 = params[392]
            else:
        ...
        if inputs[8] >= 0.5:
            ...
            if inputs[5] >= 2.5:
                ...
                if inputs[4] >= -0.5:
                    ...
                    var27 = params[409]
    if inputs[4] >= -0.5:
        if inputs[0] >= -1.0262969:
            if inputs[0] >= -0.9953841:
                if inputs[0] >= -0.98751426:
                    var28 = params[410]
                else:
                    var28 = params[411]
            else:
                if inputs[0] >= -0.99696934:
                    var28 = params[412]
                else:
                    var28 = params[413]
        else:
            if inputs[0] >= -1.0285616:
                var28 = params[414]
            else:
                if inputs[1] >= 1.0295516:
                    var28 = params[415]
        ...
        if inputs[0] >= -0.5803817:
            ...
            if inputs[0] >= -0.734946:
                if inputs[0] >= -0.73285115:
                    var28 = params[421]
                else:
                    var28 = params[422]
            else:
                if inputs[0] >= -0.794507:
                    var28 = params[423]
                else:
                    var28 = params[424]
    if inputs[0] >= -0.875073:
        if inputs[0] >= -0.8619379:
            if inputs[1] >= 0.28105152:
                if inputs[5] >= 1.5:
                    var29 = params[425]
                else:
        ...
        if inputs[0] >= -0.8769413:
            ...
            if inputs[6] >= 4.5:
                if inputs[0] >= -0.8780737:
                    var29 = params[435]
                else:
                    var29 = params[436]
            else:
                if inputs[0] >= -0.9050234:
                    var29 = params[437]
                else:
                    var29 = params[438]
